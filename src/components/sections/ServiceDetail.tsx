  ...
  return (
    <>
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-6 py-10 md:grid-cols-[1.2fr_0.8fr] md:py-14">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-cyan">Service</p>
          <h1 className="mt-3 font-display text-4xl font-semibold leading-tight md:text-5xl">{content.heroTitle}</h1>
        ...
        <div className="surface rounded-2xl p-6">
          ...
          <Link
            href="/contact"
            className="focus-ring mt-5 inline-flex rounded-md bg-cyan px-4 py-2 text-sm font-semibold text-bg transition-opacity hover:opacity-90"
          >
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-6 px-6 pb-12 md:grid-cols-2">
        ...
        <article className="surface rounded-2xl p-6">
          <h2 className="font-display text-2xl font-semibold">What we deliver</h2>
          <ul className="mt-4 space-y-3 text-sm leading-relaxed text-textSoft">
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-12">
        <article className="surface rounded-2xl p-6">
          <h2 className="font-display text-2xl font-semibold">KPI examples</h2>
          <div className="mt-4 flex flex-wrap gap-2">
            {content.kpis.map((kpi) => (
              <span
                key={kpi}
                className="rounded-full border border-cyan/35 bg-cyan/10 px-3 py-1 text-xs font-medium tracking-wide text-cyan"
              >
                {kpi}
              </span>
            ))}
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-12">
        <h2 className="mb-4 font-display text-2xl font-semibold">Pricing</h2>
        <PricingCard
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-12">
        <article className="surface rounded-2xl p-6">
          <h2 className="font-display text-2xl font-semibold">Engagement model</h2>
      ...
      <section className="mx-auto w-full max-w-7xl px-6 pb-20">
        <h2 className="mb-4 font-display text-2xl font-semibold">FAQ</h2>
